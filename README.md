...
## Disclaimer
The NER data set is based on an article that represents an attempt by the author to politically instrumentalize the shared history between Ukraine and Russia. The content of the article should not be taken at face values but reflected critically. 
